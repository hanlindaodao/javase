...
public class FileDemo01 {
    ...
    public static void main(String[] args) {
        ...
        File f2 = new File("D:\\daodao\\learn\\Java\\IdeaProjects", "twoSemester\\myFile\\java.txt");
        System.out.println(f2);

        File f3 = new File("D:\\daodao\\learn\\Java\\IdeaProjects");
        File f4 = new File(f3, "twoSemester\\myFile\\java.txt");
